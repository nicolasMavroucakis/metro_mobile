...
const NavBar: React.FC<NavBar> = ({ navigation }) => {
    ...
    return(
        <View style={[styleIndex.nav_bar, modoEscuro ? styleIndex.nav_bar_dark : null]}>
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate('Equipamentos')} // Navega para a tela Home
                style={styleIndex.button}
            >
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate('QRCode')} // Navega para a tela Home
                style={styleIndex.button}
            >   
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate('Manutencoes')} // Navega para a tela Home
                style={styleIndex.button}
            >
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate('Usuario')} // Navega para a tela Home
                style={styleIndex.button}
            >   
                <Image 
